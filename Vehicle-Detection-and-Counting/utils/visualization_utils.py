...
def save_image_array_as_png(image, output_path):
  ...
  """
    ...
    with tf.compat.v2.io.gfile.Open(output_path, 'w') as fid:
...
def draw_bounding_box_on_image(current_frame_number, image,
  ...
  """
    ...
    if (
            bottom > ROI_POSITION):  # if the vehicle get in ROI area, vehicle predicted_speed predicted_color algorithms are called - 200 is an arbitrary value, for my case it looks very well to set position of ROI line at y pixel 200
